      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="flex items-center p-4"> 
            <img src={product.image} alt={product.name} className="w-10 h-10 object-contain mr-4 rounded-lg" />
          ...
          <div className="p-6">
            ...
            <div className="mb-6">
              <div className="text-base font-semibold text-blue-600 mb-2"> {/* Changed price color here */}
                {product.price} MT
              </div>
