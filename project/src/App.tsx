...
import { ShoppingCart, Star, ChevronRight, Menu as MenuIcon, X, Instagram, MessageSquare, ArrowLeft } from 'lucide-react';
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-white to-transparent">
          <div className="max-w-7xl mx-auto px-4 h-full flex items-center">
            <div className="max-w-2xl">
              ...
              <Link 
                to="/categorias" 
                className="bg-blue-600 hover:bg-blue-700 px-6 py-3 rounded-lg flex items-center text-base text-white w-fit transition-all duration-300 hover:scale-105"
              >
                Comprar
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              ...
              <div className="flex items-center space-x-4">
                <Link to="/categorias" className="p-2 rounded-full hover:bg-gray-100">
